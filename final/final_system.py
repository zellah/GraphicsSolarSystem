...
larger planets.
The textures on the larger planets, specifically on Jupiter, appear to
be fluid where the texture map's edges meet. Technically since the colors on
the surface of each planet are swirling gasses this isn't too inaccurate,
although it isn't the expected result.
...
def SolarSystem():
    ...
    #For the larger planets, different interpolatiob
